export default `
 ...
 void main() {
    ...
    // Adjust the gl_PointSize calculation here
    float size = u_partical_size * (1.0 / - viewPosition.z);
    gl_PointSize = max(size, 1.0); // Ensure point size does not go below 1.0
}
`;
